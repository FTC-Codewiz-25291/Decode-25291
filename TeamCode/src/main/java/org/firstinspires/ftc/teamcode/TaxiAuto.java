...
@Autonomous(name = "Auto Taxi Forward", group = "Autonomous")
public class TaxiAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("Status", "Ready to Taxi");
        telemetry.update();
        ...
        if (opModeIsActive()) {
            ...
            telemetry.addData("Status", "Taxi Complete");
            telemetry.update();
        }
    }
}
